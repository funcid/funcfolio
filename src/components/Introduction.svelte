...
<div class="flex flex-col lg:flex-row items-center justify-between gap-[90rem] lg:gap-[120rem]">
    ...
    <div class="flex flex-col items-center lg:items-start gap-[60rem] lg:gap-[40rem] order-2 lg:order-1">
        ...
        <!-- Социальные сети -->
        <div class="flex gap-[15rem] lg:gap-[12rem]">
            <!-- Telegram -->
            <a 
                href="https://t.me/funcid" 
                target="_blank"
                rel="noreferrer noopener"
                class="social-link flex items-center gap-[12rem] lg:gap-[10rem] px-[25rem] h-[70rem] lg:h-[60rem] rounded-[20rem] bg-[#229ED9] text-white"
            >
                <!-- Иконка Telegram -->
                <svg class="w-[24rem] h-[24rem]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <!-- Текст -->
                <span class="text-[20rem] lg:text-[18rem] font-onest font-medium">
                    TG
                </span>
            </a>
            ...
            <a 
                ...
                target="_blank"
                rel="noreferrer noopener"
                class="social-link flex items-center gap-[12rem] lg:gap-[10rem] px-[25rem] h-[70rem] lg:h-[60rem] rounded-[20rem] bg-[#0077FF] text-white"
            >
                <!-- Иконка VK -->
                <svg class="w-[24rem] h-[24rem]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a 
                ...
                target="_blank"
                rel="noreferrer noopener"
                class="social-link flex items-center gap-[12rem] lg:gap-[10rem] px-[25rem] h-[70rem] lg:h-[60rem] rounded-[20rem] bg-[#25D366] text-white"
            >
                <!-- Иконка WhatsApp -->
                <svg class="w-[24rem] h-[24rem]" viewBox="0 0 24 24" fill="currentColor">
